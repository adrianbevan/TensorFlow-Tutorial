"""
    NN_para_save.py  - This is an MLP example using Keras to learn the function y=x^2, 
                       and store the output of the model for recall later.
...
print("--------------------------------------------------------------------------------------------------------------")
print("\033[1mWill train a multilayer perceptron using some toy data following y = x^2\033[0m")
print("--------------------------------------------------------------------------------------------------------------\n\n")
...
print("\033[1mSave the model now\033[0m")
model.save('model')
