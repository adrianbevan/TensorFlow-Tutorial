...
print("--------------------------------------------------------------------------------------------------------------")
print("Will scan through the leaky relu alpha parameter to explore the model performance as a function of this hyperparameter")
print("--------------------------------------------------------------------------------------------------------------\n\n")
...
plt.ylabel('accuracy')
plt.xlabel('Leaky ReLU alpha value')
